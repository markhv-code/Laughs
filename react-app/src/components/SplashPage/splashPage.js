...
export default function SplashPage() {
    return (
        <>
            <div>
                <img className="object-contain" alt="Laughs App logo" src={`${process.env.PUBLIC_URL}/pyp-logo-cropped.png`}></img>
            </div>
            <div>
            ...
            <div className="grid grid-flow-col grid-cols-4 grid-rows-4">
                ...
                <div className="col-start-2 col-end-5 row-start-1 row-end-4">
                    <img className="rounded-lg md:w-1/2" alt="Laughing Man" src={`${process.env.PUBLIC_URL}/laughing-man-holding-pen-in-meeting.jpg`}></img>
                </div>
            </div>
